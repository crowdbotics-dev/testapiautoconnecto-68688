...
## Project Structure
    ...
    ├── testapiautoconnecto_68688  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_68688`
...
2. Clone this repo and `cd testapiautoconnecto_68688`
